# Kubernetes Interview Notes — Index

Notes are organized around the Kubernetes concepts taxonomy.

- **Interview Guide:** a concise study path, answer pattern, and incident triage map. See [Kubernetes Interview Guide](INTERVIEW-GUIDE.md).
...
- **Managed Kubernetes:** provider-focused operations notes for [EKS](EKS/README.md), [GKE](GKE/README.md), and [AKS](AKS/README.md).
- **Platform tooling:** [Karpenter](karpenter/README.md) node provisioning and [Istio](istio/README.md) service-mesh notes.

Use these folders as the canonical organization for interview prep and quick reference.
